...
#
# `sbatch /pic/projects/GCAM/stitches_pic/stitches_repo/stitches/modules/run_paper_experiment_miniCMIP.sh`
#
# ------------------------------------------------------------------------------
...
python /pic/projects/GCAM/stitches_pic/stitches_repo/stitches/modules/paper_experiment_miniCMIP.py
