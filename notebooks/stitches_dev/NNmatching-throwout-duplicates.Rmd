...
Want to work with an archive that will guarantee we get matches within a single generated ensemble member, so that we can make sure the function for dropping those duplicates behaves as intended.
