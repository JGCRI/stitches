...
# TODO 
# Okay some times the generate_gridded_recepie funtion throws an error related to the neighborhood matching 
# but it is not consistent. 
recipes <- generate_gridded_recepie(target_data = bind_rows(target_data, target_data2), 
                                    archive_data = archive_subset, n = 4)
write.csv(recipes, file = "./recpies_for_python.csv", row.names = FALSE)
```
