...
start1 <- Sys.time()
recipes <- permute_stitching_recipes(N_matches = 48, matched_data = matched_data_identical_hist)
end1 <- Sys.time()

```


So we can see there's an exponential time difference between producing 2 and producing all possible matches (ie 48 matches takes much more than 24 times as long as 2 matches).
