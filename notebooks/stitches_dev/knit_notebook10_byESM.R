...
for (name_ind in 1:length(esm_name_vec)){
  for (exp_ind in 1:length(esm_experiment_vec)){
    ...
    rmarkdown::render(input = "Notebook10-tolerance-numgenerated-relationship.Rmd", output_file = paste0("Notebook10_", esm_name, "_", esm_experiment, "_CFensemble_size_vs_tol.html"))
  }
}
